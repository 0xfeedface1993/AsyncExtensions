...
final class AsyncLazySequenceTests: XCTestCase {
    ...
    func test_AsyncLazySequence_returns_an_asyncSequence_that_finishes_when_task_is_cancelled() {
        ...
        let allSignalCompleteExceptation = expectation(description: "All expectation fulfilled")
        ...
        let task = Task {
            ...
            for await element in sut {
                ...
                allSignalCompleteExceptation.fulfill()
            }
        ...
        wait(for: [allSignalCompleteExceptation], timeout: 5)
    }
}
